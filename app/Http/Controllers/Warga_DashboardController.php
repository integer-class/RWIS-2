...
class Warga_DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('warga.index', compact('type_menu', 'penduduk','penduduk_hitung', 'password_default', 'pengumuman_rt', 'tanggal_sekarang', 'tanggal_pengumuman','jumlah_kas', 'kartu_keluarga', 'jumlah_laki', 'jumlah_perempuan', 'iuran_bulanan', 'nama_bulan', 'labels_usia', 'data_usia'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('warga.show', compact('penduduk', 'type_menu', 'penduduk_kk', 'jumlah_anggota_keluarga'));
    }
