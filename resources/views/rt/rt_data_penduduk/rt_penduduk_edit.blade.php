...
@section('main')
    <div class="main-content">
        <section class="section">
            ...
            <h2 class="section">
                <a style="width:130px; height:38px; margin-bottom:20px" href="{{ route('rt_penduduk.index') }}" class="btn btn-lg btn-primary">Kembali</a>
            </h2>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('rt_penduduk.update', $penduduk->nik) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
