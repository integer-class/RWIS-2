          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <div class="text-center">
                <h1 class="mb-3 text-white">Awakmu ready cak???</h1>
                <div class="pt-3">
                  <p class="px-lg-6 mb-5 text-white">
                    IKAN HIU IKAN SEPAT<br>
                  <i>lanjutin sendiri</i>
                  </p>
                  
                </div><a class="btn btn-white text-cornflower-blue" href="page-contact.html">Koling-Koling</a>
              </div>
            </div>
          </div>
        </div>
